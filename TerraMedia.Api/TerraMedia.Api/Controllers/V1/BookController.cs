...
public class BooksController : MainController
{
    ...
    [SwaggerResponse((int)HttpStatusCode.Created, "Livro criado com comentário com sucesso", typeof(ResponseDto<BookDto>))]
    public async Task<IActionResult> CreateWithComment(int coverId, [FromBody] BookCommentDto commentDto)
    {
        ...
        return Ok(ResponseDto.Create(HttpStatusCode.Created, "Comentário cadastrado com sucesso", result));
    }
    ...
    [SwaggerResponse((int)HttpStatusCode.OK, "Comentário cadastrado com sucesso", typeof(ResponseDto<BookDto>))]
    ...
    public async Task<IActionResult> AddComment(Guid bookId, [FromBody] CommentDto commentDto)
    {
        ...
        return Ok(ResponseDto.Create(HttpStatusCode.OK, "Comentário cadastrado com sucesso", result));
    }
    ...
    [SwaggerResponse((int)HttpStatusCode.OK, "Comentário atualizado com sucesso", typeof(ResponseDto<BookDto>))]
    ...
    public async Task<IActionResult> UpdateComment(Guid bookId, Guid commentId, [FromBody] CommentDto commentDto)
    {
        ...
        return Ok(ResponseDto.Create(HttpStatusCode.OK, "Comentário atualizado com sucesso", result));
    }
    ...
    public async Task<IActionResult> RemoveComment(Guid bookId, Guid commentId)
    {
        ...
        return Ok(ResponseDto.Create(HttpStatusCode.NoContent, "Comentário removido com sucesso"));
    }
    ...
    [SwaggerResponse((int)HttpStatusCode.OK, "Informações carregadas com sucesso.", typeof(ResponseDto<BookDto>))]
    [SwaggerResponse((int)HttpStatusCode.NotFound, "Livro não encontrado")]
    public async Task<IActionResult> GetBook(int coverId)
    {
        var result = await _service.GetByIdWithCommentsAsync(coverId);
        if (result == null)
            return NotFound(ResponseDto.Create(HttpStatusCode.NotFound, "Livro não encontrado."));

        return Ok(ResponseDto.Create(HttpStatusCode.OK, "Informações carregadas com sucesso.", result));
    }
}
